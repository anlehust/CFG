...
public class Graph {
	...
	private int cleanup(){
		...
		lines = clc.separateStatements(lines);
		printAllLine();

		//Combine any multi-line statements
		lines = clc.combineStatements(lines);
		printAllLine();
		...
		lines = clc.turnForLoopsToWhileLoops(lines);
		printAllLine();

		//separate case statements with next line
		lines = clc.separateCaseStatement(lines);
		printAllLine();
	...
	private void getNodes(){	
		...
		ModifyEdge modifyEdge = new ModifyEdge();
